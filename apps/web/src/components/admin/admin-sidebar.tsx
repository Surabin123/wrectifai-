  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {collapsed ? (
            <div className="relative h-[32px] w-[50px] overflow-hidden bg-white dark:bg-white rounded-md flex items-center justify-center shadow-sm">
              <Image
                src="/fin_logo.png"
                alt="WrectifAI"
                width={1024}
            ...
            <div className="relative h-[62px] w-full overflow-hidden bg-white dark:bg-white rounded-lg flex items-center justify-center shadow-sm p-1">
              <Image
                src="/fin_logo.png"
                alt="WrectifAI"
                width={1024}
