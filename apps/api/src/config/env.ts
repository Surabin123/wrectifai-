...
export function getEnv(envSource: Record<string, string | undefined> = process.env) {
  ...
  return {
    ...
    llmModel: (envSource.LLM_MODEL === 'llama-3.1-70b-versatile' || envSource.LLM_MODEL === 'llama3-70b-8192') ? 'llama-3.3-70b-versatile' : (envSource.LLM_MODEL ?? 'llama-3.3-70b-versatile'),
    groqApiKey: anyKey,
    openaiApiKey: anyKey,
